...
public class AutoPhotoLayout extends LinearLayoutCompat {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < cCount; i++) {
            ...
            //测量子View的宽和高
            measureChild(child,widthMeasureSpec,heightMeasureSpec);// TODO: 2019/7/31 这一行的目的是什么
            //得到layoutParams
            ...
            if (i == cCount - 1){
                ...
                //判断是否超过最大拍照限制
                height +=lineHight;// TODO: 2019/7/31 这里不是没判断吗
            }
        }
        ...
        if (!mIsOnceInitOnMeasure){
            mLayoutParams = new LayoutParams(imageSideLen,imageSideLen);
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < lineNum; i++) {
            ...
            for (int j = 0; j < size; j++) {
                ...
                final int rc = lc + child.getMeasuredWidth() - mImageMargin;// TODO: 2019/8/2 mImageMargin 是什么东西
    ...
    private void createNewImageView(){
        ...
        mTargetImageView.setOnLongClickListener(new OnLongClickListener() {
            @Override
